package com.entando.ps.web.rest;

import com.entando.ps.domain.Conference;
import com.entando.ps.repository.ConferenceRepository;
import com.entando.ps.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.entando.ps.domain.Conference}.
 */
@RestController
@RequestMapping("/api")
@Transactional
